...
import { BaseEntity, AuditableEntity, CollaborationMode, AIInsight, RiskLevel, Priority, Status, KPI } from './core';
...
export enum QualityObjectiveType {
...
export enum NonConformanceType {
  MINOR = 'MINOR',
  MAJOR = 'MAJOR',
  CRITICAL = 'CRITICAL',
...
export enum QualityControlPoint {
...
export enum CollaborativeDecisionType {
  ACCEPT = 'ACCEPT',
  REJECT = 'REJECT',
  REWORK = 'REWORK',
  USE_AS_IS = 'USE_AS_IS',
...
// ===========================================
// Core Quality Management Interfaces
// ===========================================
...
// ===========================================
// Inspection Workflow Interfaces
// ===========================================
...
// ===========================================
// Inspection Execution Interfaces
// ===========================================
...
export interface InspectorAssignment {
  ...
  specialties: string[];
  currentLoad: number; // number of active inspections
...
export interface Uncertainty {
  value: number;
  unit: string;
  confidenceLevel: number; // typically 95% or 99%
  method: string;
...
// ===========================================
// Non-Conformance Management Interfaces
// ===========================================
...
export interface NonConformanceCost {
  ...
  correction: number;
  prevention: number;
  external: number; // customer impact, regulatory fines
  total: number;
  currency: string;
}
...
export interface QualityMetric extends BaseEntity {
  ...
  trends: Trend[];
  alerts: QualityAlert[];
  applicableEntities: string[]; // product, process, supplier IDs
}
...
// ===========================================
// Quality Collaboration Interfaces
// ===========================================
...
export interface HumanInTheLoopConfig {
  ...
  reviewers: string[];
  responseTimeLimit: number; // in hours
}
