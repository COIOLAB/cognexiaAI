...
let QuantumController = QuantumController_1 = class QuantumController {
    constructor() {
        this.logger = new common_1.Logger(QuantumController_1.name);
    }
    // =================== QUANTUM COMPUTING ===================
    async getQuantumProcessors() {
        try {
            ...
            throw new common_1.HttpException('Failed to retrieve quantum processors', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    // =================== QUANTUM OPTIMIZATION ===================
    async getQuantumOptimizationJobs(status, algorithm) {
        try {
            return {
                success: true,
                data: {
            ...
            throw new common_1.HttpException('Failed to retrieve quantum optimization jobs', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async submitQuantumOptimization(optimizationRequest) {
        try {
            return {
                success: true,
                data: {
            ...
            throw new common_1.HttpException('Failed to submit quantum optimization', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    // =================== QUANTUM SENSORS ===================
    async getQuantumSensors(sensorType, workCenterId) {
        try {
            return {
                success: true,
                data: {
            ...
            throw new common_1.HttpException('Failed to retrieve quantum sensors', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    // =================== QUANTUM SECURITY ===================
    async getQuantumSecurity() {
        try {
            ...
            throw new common_1.HttpException('Failed to retrieve quantum security status', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    // =================== QUANTUM ANALYTICS ===================
    async getQuantumAnalytics() {
        try {
            ...
            throw new common_1.HttpException('Failed to retrieve quantum analytics', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
};
exports.QuantumController = QuantumController;
__decorate([
    (0, common_1.Get)('processors'),
    (0, swagger_1.ApiOperation)({
        summary: 'Get quantum processors status',
        description: 'Monitor quantum computing resources and their operational status'
    }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Quantum processors status retrieved successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'quantum_engineer', 'viewer'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], QuantumController.prototype, "getQuantumProcessors", null);
__decorate([
    (0, common_1.Get)('optimization/jobs'),
    (0, swagger_1.ApiOperation)({
    ...
    (0, swagger_1.ApiQuery)({ name: 'algorithm', required: false }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Quantum optimization jobs retrieved successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'quantum_engineer', 'optimization_specialist', 'viewer'),
    __param(0, (0, common_1.Query)('status')),
    __param(1, (0, common_1.Query)('algorithm')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], QuantumController.prototype, "getQuantumOptimizationJobs", null);
__decorate([
    (0, common_1.Post)('optimization/submit'),
    (0, swagger_1.ApiOperation)({
        summary: 'Submit quantum optimization job',
        description: 'Submit a new quantum optimization problem for processing'
    }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Quantum optimization job submitted successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'quantum_engineer', 'optimization_specialist'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], QuantumController.prototype, "submitQuantumOptimization", null);
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'sensorType', required: false }),
    (0, swagger_1.ApiQuery)({ name: 'workCenterId', required: false }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Quantum sensors data retrieved successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'quantum_engineer', 'sensor_technician', 'viewer'),
    __param(0, (0, common_1.Query)('sensorType')),
    __param(1, (0, common_1.Query)('workCenterId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], QuantumController.prototype, "getQuantumSensors", null);
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Quantum security status retrieved successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'security_officer', 'quantum_engineer'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], QuantumController.prototype, "getQuantumSecurity", null);
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Quantum analytics retrieved successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'quantum_engineer', 'viewer'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], QuantumController.prototype, "getQuantumAnalytics", null);
exports.QuantumController = QuantumController = QuantumController_1 = __decorate([
    (0, swagger_1.ApiTags)('Quantum Technology'),
