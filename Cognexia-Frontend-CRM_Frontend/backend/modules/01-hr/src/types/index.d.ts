...
export declare enum HiringDecision {
    HIRE = "hire",
    NO_HIRE = "no_hire",
    MAYBE = "maybe",
...
export declare enum BenefitStatus {
    ACTIVE = "active",
    INACTIVE = "inactive",
    PENDING = "pending",
    EXPIRED = "expired",
...
export declare const HRErrorCodesExtension: {
    readonly ALREADY_CLOCKED_IN: "ALREADY_CLOCKED_IN";
    readonly NOT_CLOCKED_IN: "NOT_CLOCKED_IN";
    readonly LEAVE_REQUEST_OVERLAP: "LEAVE_REQUEST_OVERLAP";
    readonly INVALID_LEAVE_REQUEST: "INVALID_LEAVE_REQUEST";
    readonly INVALID_PERFORMANCE_DATA: "INVALID_PERFORMANCE_DATA";
    readonly INVALID_JOB_REQUISITION_DATA: "INVALID_JOB_REQUISITION_DATA";
    readonly INVALID_REQUISITION_DATA: "INVALID_REQUISITION_DATA";
    readonly EMPLOYEE_NOT_FOUND: HRErrorCodes.EMPLOYEE_NOT_FOUND;
    readonly INVALID_EMPLOYEE_DATA: HRErrorCodes.INVALID_EMPLOYEE_DATA;
    readonly DUPLICATE_EMPLOYEE_EMAIL: HRErrorCodes.DUPLICATE_EMPLOYEE_EMAIL;
    readonly UNAUTHORIZED_ACCESS: HRErrorCodes.UNAUTHORIZED_ACCESS;
    readonly INVALID_MANAGER_ASSIGNMENT: HRErrorCodes.INVALID_MANAGER_ASSIGNMENT;
    readonly REQUISITION_NOT_FOUND: HRErrorCodes.REQUISITION_NOT_FOUND;
    readonly APPLICATION_NOT_FOUND: HRErrorCodes.APPLICATION_NOT_FOUND;
    readonly CANDIDATE_NOT_FOUND: HRErrorCodes.CANDIDATE_NOT_FOUND;
    readonly INTERVIEW_SCHEDULING_CONFLICT: HRErrorCodes.INTERVIEW_SCHEDULING_CONFLICT;
    readonly PERFORMANCE_REVIEW_NOT_FOUND: HRErrorCodes.PERFORMANCE_REVIEW_NOT_FOUND;
    readonly INVALID_PERFORMANCE_REVIEW_DATA: HRErrorCodes.INVALID_PERFORMANCE_REVIEW_DATA;
    readonly COMPENSATION_PLAN_NOT_FOUND: HRErrorCodes.COMPENSATION_PLAN_NOT_FOUND;
    readonly COMPENSATION_PLAN_ALREADY_EXISTS: HRErrorCodes.COMPENSATION_PLAN_ALREADY_EXISTS;
    readonly INVALID_COMPENSATION_DATA: HRErrorCodes.INVALID_COMPENSATION_DATA;
    readonly SALARY_STRUCTURE_NOT_FOUND: HRErrorCodes.SALARY_STRUCTURE_NOT_FOUND;
    readonly SALARY_STRUCTURE_OVERLAP: HRErrorCodes.SALARY_STRUCTURE_OVERLAP;
    readonly BENEFITS_PLAN_NOT_FOUND: HRErrorCodes.BENEFITS_PLAN_NOT_FOUND;
    readonly BENEFITS_PLAN_ALREADY_EXISTS: HRErrorCodes.BENEFITS_PLAN_ALREADY_EXISTS;
    readonly BENEFITS_ENROLLMENT_NOT_FOUND: HRErrorCodes.BENEFITS_ENROLLMENT_NOT_FOUND;
    readonly BENEFITS_ENROLLMENT_EXISTS: HRErrorCodes.BENEFITS_ENROLLMENT_EXISTS;
    readonly BENEFITS_ENROLLMENT_NOT_ELIGIBLE: HRErrorCodes.BENEFITS_ENROLLMENT_NOT_ELIGIBLE;
    readonly PAYROLL_RUN_NOT_FOUND: HRErrorCodes.PAYROLL_RUN_NOT_FOUND;
    readonly PAYROLL_PERIOD_OVERLAP: HRErrorCodes.PAYROLL_PERIOD_OVERLAP;
    readonly INVALID_PAYROLL_STATUS: HRErrorCodes.INVALID_PAYROLL_STATUS;
    readonly INVALID_PAYROLL_DATA: HRErrorCodes.INVALID_PAYROLL_DATA;
    readonly EXIT_RECORD_NOT_FOUND: HRErrorCodes.EXIT_RECORD_NOT_FOUND;
    readonly INVALID_EXIT_DATA: HRErrorCodes.INVALID_EXIT_DATA;
    readonly INVALID_EXIT_INTERVIEW_DATA: HRErrorCodes.INVALID_EXIT_INTERVIEW_DATA;
    readonly EXIT_INTERVIEW_NOT_FOUND: HRErrorCodes.EXIT_INTERVIEW_NOT_FOUND;
    readonly OFFBOARDING_CHECKLIST_NOT_FOUND: HRErrorCodes.OFFBOARDING_CHECKLIST_NOT_FOUND;
    readonly KNOWLEDGE_TRANSFER_PLAN_NOT_FOUND: HRErrorCodes.KNOWLEDGE_TRANSFER_PLAN_NOT_FOUND;
    readonly INTERNAL_ERROR: HRErrorCodes.INTERNAL_ERROR;
};
export declare enum HRErrorCodesComplete {
    EMPLOYEE_NOT_FOUND = "EMPLOYEE_NOT_FOUND",
    INVALID_EMPLOYEE_DATA = "INVALID_EMPLOYEE_DATA",
    DUPLICATE_EMPLOYEE_EMAIL = "DUPLICATE_EMPLOYEE_EMAIL",
    UNAUTHORIZED_ACCESS = "UNAUTHORIZED_ACCESS",
