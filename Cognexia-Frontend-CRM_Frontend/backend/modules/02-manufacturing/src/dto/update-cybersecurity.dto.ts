...
export class UpdateCybersecurityDto {
  ...
  @ApiPropertyOptional({ description: 'Current threat level', enum: ThreatLevel })
  @IsOptional()
  @IsEnum(ThreatLevel)
  currentThreatLevel?: ThreatLevel;

  @ApiPropertyOptional({ description: 'Compliance framework', enum: ComplianceFramework })
  @IsOptional()
