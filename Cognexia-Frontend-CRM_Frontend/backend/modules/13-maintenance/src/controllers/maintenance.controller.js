...
let MaintenanceController = MaintenanceController_1 = class MaintenanceController {
    ...
    async getAllEquipment(page, limit, workCenterId, status, criticality) {
        try {
            return {
                success: true,
                data: {
            ...
            throw new common_1.HttpException('Failed to retrieve equipment', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async getEquipment(id) {
        try {
            ...
            throw new common_1.HttpException('Equipment not found', common_1.HttpStatus.NOT_FOUND);
        }
    }
    // =================== MAINTENANCE SCHEDULING ===================
    async getMaintenanceSchedule(dateFrom, dateTo, workCenterId, maintenanceType) {
        try {
            return {
                success: true,
                data: {
            ...
            throw new common_1.HttpException('Failed to retrieve maintenance schedule', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async createMaintenanceTask(createTaskDto) {
        try {
            return {
                success: true,
                data: {
            ...
            throw new common_1.HttpException('Failed to create maintenance task', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    // =================== WORK ORDERS ===================
    async getMaintenanceWorkOrders(status, priority, technician) {
        try {
            return {
                success: true,
                data: {
            ...
            throw new common_1.HttpException('Failed to retrieve maintenance work orders', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async startMaintenanceWorkOrder(id, startData) {
        try {
            return {
                success: true,
                data: {
            ...
            throw new common_1.HttpException('Failed to start maintenance work order', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async completeMaintenanceWorkOrder(id, completionData) {
        try {
            return {
                success: true,
                data: {
            ...
            throw new common_1.HttpException('Failed to complete maintenance work order', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    // =================== ANALYTICS & REPORTS ===================
    async getMaintenanceAnalytics(timeRange) {
        try {
            return {
                success: true,
                data: {
            ...
            throw new common_1.HttpException('Failed to retrieve maintenance analytics', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    // =================== PREDICTIVE MAINTENANCE ===================
    async getPredictiveInsights(equipmentId) {
        try {
            return {
                success: true,
                data: {
            ...
            throw new common_1.HttpException('Failed to retrieve predictive insights', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    // =================== SPARE PARTS MANAGEMENT ===================
    async getSparePartsInventory(equipmentId, status) {
        try {
            return {
                success: true,
                data: {
            ...
            throw new common_1.HttpException('Failed to retrieve spare parts inventory', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'criticality', required: false }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Equipment list retrieved successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'supervisor', 'maintenance_technician', 'viewer'),
    __param(0, (0, common_1.Query)('page')),
    __param(1, (0, common_1.Query)('limit')),
    __param(2, (0, common_1.Query)('workCenterId')),
    __param(3, (0, common_1.Query)('status')),
    __param(4, (0, common_1.Query)('criticality')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, String, String, String]),
    __metadata("design:returntype", Promise)
], MaintenanceController.prototype, "getAllEquipment", null);
__decorate([
    (0, common_1.Get)('equipment/:id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get equipment details by ID' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Equipment UUID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Equipment details found' }),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'workCenterId', required: false }),
    (0, swagger_1.ApiQuery)({ name: 'maintenanceType', required: false }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Maintenance schedule retrieved successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'supervisor', 'maintenance_technician', 'viewer'),
    __param(0, (0, common_1.Query)('dateFrom')),
    __param(1, (0, common_1.Query)('dateTo')),
    __param(2, (0, common_1.Query)('workCenterId')),
    __param(3, (0, common_1.Query)('maintenanceType')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String]),
    __metadata("design:returntype", Promise)
], MaintenanceController.prototype, "getMaintenanceSchedule", null);
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Maintenance task scheduled successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'supervisor', 'maintenance_technician'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], MaintenanceController.prototype, "createMaintenanceTask", null);
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'technician', required: false }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Maintenance work orders retrieved successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'supervisor', 'maintenance_technician', 'viewer'),
    __param(0, (0, common_1.Query)('status')),
    __param(1, (0, common_1.Query)('priority')),
    __param(2, (0, common_1.Query)('technician')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", Promise)
], MaintenanceController.prototype, "getMaintenanceWorkOrders", null);
__decorate([
    (0, common_1.Put)('work-orders/:id/start'),
    (0, swagger_1.ApiOperation)({
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Maintenance work order started successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'supervisor', 'maintenance_technician'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], MaintenanceController.prototype, "startMaintenanceWorkOrder", null);
__decorate([
    (0, common_1.Put)('work-orders/:id/complete'),
    (0, swagger_1.ApiOperation)({
        summary: 'Complete maintenance work order',
        description: 'Mark maintenance work order as completed'
    }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Work order UUID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Maintenance work order completed successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'supervisor', 'maintenance_technician'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], MaintenanceController.prototype, "completeMaintenanceWorkOrder", null);
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Maintenance analytics retrieved successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'supervisor', 'viewer'),
    __param(0, (0, common_1.Query)('timeRange')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], MaintenanceController.prototype, "getMaintenanceAnalytics", null);
__decorate([
    (0, common_1.Get)('predictive/insights'),
    (0, swagger_1.ApiOperation)({
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], MaintenanceController.prototype, "getPredictiveInsights", null);
__decorate([
    (0, common_1.Get)('spare-parts'),
    (0, swagger_1.ApiOperation)({
    ...
    (0, swagger_1.ApiQuery)({ name: 'equipmentId', required: false }),
    (0, swagger_1.ApiQuery)({ name: 'status', required: false }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Spare parts inventory retrieved successfully' }),
    (0, roles_decorator_1.Roles)('admin', 'manager', 'supervisor', 'maintenance_technician', 'viewer'),
    __param(0, (0, common_1.Query)('equipmentId')),
    ...
    __metadata("design:returntype", Promise)
], MaintenanceController.prototype, "getSparePartsInventory", null);
exports.MaintenanceController = MaintenanceController = MaintenanceController_1 = __decorate([
    (0, swagger_1.ApiTags)('Maintenance Management'),
