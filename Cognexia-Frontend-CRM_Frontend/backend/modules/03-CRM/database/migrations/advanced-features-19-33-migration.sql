...
CREATE INDEX IF NOT EXISTS idx_churn_org_date ON churn_predictions(organization_id, prediction_date);
...
CREATE INDEX IF NOT EXISTS idx_rec_org_status ON recommendations(organization_id, status);
...
CREATE INDEX IF NOT EXISTS idx_anomaly_org_date ON anomaly_detections(organization_id, detected_at);
...
CREATE INDEX IF NOT EXISTS idx_perf_org_date ON performance_metrics(organization_id, recorded_at);
...
CREATE INDEX IF NOT EXISTS idx_invoice_org_date ON invoices(organization_id, invoice_date);
...
CREATE INDEX IF NOT EXISTS idx_milestone_org_status ON customer_success_milestones(organization_id, status);
...
CREATE INDEX IF NOT EXISTS idx_support_org_date ON support_analytics(organization_id, date);
...
CREATE INDEX IF NOT EXISTS idx_sandbox_org_status ON sandbox_environments(organization_id, status);
