...
CREATE INDEX IF NOT EXISTS idx_customers_org_id ON crm_customers(organization_id);
CREATE INDEX IF NOT EXISTS idx_leads_org_id ON crm_leads(organization_id);
CREATE INDEX IF NOT EXISTS idx_opportunities_org_id ON crm_opportunities(organization_id);
CREATE INDEX IF NOT EXISTS idx_contacts_org_id ON crm_contacts(organization_id);
CREATE INDEX IF NOT EXISTS idx_tasks_org_id ON crm_tasks(organization_id);
CREATE INDEX IF NOT EXISTS idx_activities_org_id ON crm_activities(organization_id);
CREATE INDEX IF NOT EXISTS idx_email_campaigns_org_id ON crm_email_campaigns(organization_id);
CREATE INDEX IF NOT EXISTS idx_support_tickets_org_id ON crm_support_tickets(organization_id);
CREATE INDEX IF NOT EXISTS idx_documents_org_id ON crm_documents(organization_id);
CREATE INDEX IF NOT EXISTS idx_forms_org_id ON crm_forms(organization_id);
CREATE INDEX IF NOT EXISTS idx_territories_org_id ON crm_territories(organization_id);
CREATE INDEX IF NOT EXISTS idx_products_org_id ON crm_products(organization_id);
CREATE INDEX IF NOT EXISTS idx_reports_org_id ON crm_reports(organization_id);
CREATE INDEX IF NOT EXISTS idx_workflows_org_id ON crm_workflows(organization_id);
CREATE INDEX IF NOT EXISTS idx_erp_mappings_org_id ON crm_erp_field_mappings(organization_id);
CREATE INDEX IF NOT EXISTS idx_erp_connections_org_id ON crm_erp_connections(organization_id);
CREATE INDEX IF NOT EXISTS idx_migration_jobs_org_id ON crm_data_migration_jobs(organization_id);
