...
### Step 2: Add organization_id to ALL Entities
...
```typescript
// All service methods MUST filter by organization_id
...
ALTER TABLE dashboards ADD COLUMN organization_id UUID REFERENCES organizations(id);
...
- [ ] Add organization_id to all 32 entities
- [ ] Create database indexes
- [ ] Enable Supabase RLS on all tables
- [ ] Create RLS policies
- [ ] Implement TenantMiddleware
- [ ] Create TenantGuard
- [ ] Update all services to filter by organization_id
...
**Next Steps:**
1. Implement the database migration to add organization_id
