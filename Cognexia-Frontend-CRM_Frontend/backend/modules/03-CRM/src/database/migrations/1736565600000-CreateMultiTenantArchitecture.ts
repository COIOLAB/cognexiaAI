...
export class CreateMultiTenantArchitecture1736565600000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'website', type: 'varchar', length: '100', isNullable: true },
          { name: 'logoUrl', type: 'text', isNullable: true },
          { name: 'master_organization_id', type: 'uuid' },
    ...
    await queryRunner.createForeignKey(
      'organizations',
      new TableForeignKey({
        columnNames: ['master_organization_id'],
    ...
    await queryRunner.createIndex(
      ...
      new TableIndex({
        ...
        columnNames: ['master_organization_id', 'status']
      })
    );
    ...
    await queryRunner.createIndex(
      ...
      new TableIndex({
        ...
        columnNames: ['organization_id', 'metricType', 'recordedAt']
      })
    );
    ...
    await queryRunner.createIndex(
      ...
      new TableIndex({
        ...
        columnNames: ['organization_id', 'userType']
      })
    );
