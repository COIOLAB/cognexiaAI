...
export class SubscriptionService {
  ...
  async changePlan(
    ...
    if (changedBy.userType !== UserType.SUPER_ADMIN && changedBy.organizationId !== organizationId) {
  ...
  async cancelSubscription(
    ...
    if (cancelledBy.userType !== UserType.SUPER_ADMIN && cancelledBy.organizationId !== organizationId) {
