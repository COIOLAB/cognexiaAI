...
CREATE INDEX idx_revenue_transactions_org ON revenue_transactions(organizationId);
...
CREATE INDEX idx_org_health_org ON organization_health_scores(organizationId);
...
CREATE INDEX idx_security_events_org ON security_events(organizationId);
...
CREATE INDEX idx_compliance_checks_org ON compliance_checks(organizationId);
...
CREATE INDEX idx_admin_tickets_org ON admin_support_tickets(organizationId);
...
CREATE INDEX idx_onboarding_org ON onboarding_checklists(organizationId);
...
CREATE INDEX idx_api_keys_org ON api_keys(organizationId);
...
CREATE INDEX idx_white_label_org ON white_label_configs(organizationId);
